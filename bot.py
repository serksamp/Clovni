...
import threading
import psutil
token = "MTA5NDIyODY1ODU3MjUwNTEzOA.Gkl0vY.7Zr7HqW_q3RsHhBG0MYs3caniqxG1-VqklRJ98"
buyers = [1090244522149167196]
admins = [1090244522149167196]
ownerList = [1090244522149167196]
...
async def on_connect():
    ...
    time.sleep(1.0)
    print("Success, Bot Is Online !!!! Owner:Clovni")
...
async def help(ctx):
	if ctx.author.id not in buyers:
		embeds = discord.Embed(title="🚀 **CLOVNI DDOS** 🚀", color=0xfcb103)
		...
		embed = discord.Embed(title="🚀 **CLOVNI DDOS** 🚀", description="✨ **HELP MENU ✨", color=discord.Colour.random())
		embed.set_author(name="CLOVNI DDoS Bot V1", icon_url="https://media2.giphy.com/media/F2U5dFf4LG1zYmnJS2/giphy.gif")
		...
		embed.set_footer(text=f"© Owner : CLOVNI | Requests By {ctx.author.name}")
		await ctx.send(embed=embed)
...
async def Userinfo(ctx, user:discord.Member=None):
	...
	embed.set_footer(text=f"© Owner : CLOVNI | Info User : {user}", icon_url=ctx.author.avatar)
...
async def vpsinfo(ctx):
	...
	embed.set_author(name="Vps Info - CLOVNI DDOS")
	...
	embed.set_footer(text="© Owner : CLOVNI | Info Bot : 🚀 CLOVNI DDOS 🚀", icon_url=ctx.author.avatar)
...
async def Botinfo(ctx):
	embed = discord.Embed(color=0x03ff28)
	embed.set_thumbnail(url="https://i.pinimg.com/originals/8f/f2/10/8ff210a59c7a8eadc434ec303f7a86f5.jpg")
	embed.set_author(name="Bot Info - CLOVNI DDOS")
	embed.add_field(name="ID :", value="1090244522149167196")
	embed.add_field(name="Name :", value="CLOVNI DDOS")
	embed.add_field(name="Bot Owner :", value="CLOVNI")
...
async def Methods(ctx):
	if ctx.author.id not in buyers:
		embedc = discord.Embed(title="🚀 **CLOVNI DDOS** 🚀", color=0xfcb103)
		embedc.add_field(name="**Warning**",value="You Don't Have Permission To Use This Comamnd !")
		embedc.set_footer(text=f"© Owner : CLOVNI | Warning {ctx.author.name}")
		await ctx.reply(embed=embedc)
	else:
		embet = discord.Embed(title="🚀 **CLOVNI DDOS** 🚀", color=discord.Colour.random())
		embet.add_field(name="**Methods Layer4**", value="```Update```")
		embet.add_field(name="**Methods Layer7**", value="```\nSLOW\nHYPER\nUAM\nUAM-BYPASS\nHTTP-RAW\nHTTP-RAND\nHTTP-SOCKETS\nIO-STRESSER\nCLOUDFLARE\nCF-BYPASS\nCLOVNI-DDOS```")
		embet.set_footer(text=f"© Owner : CLOVNI | All Methods Show")
...
async def Commands(ctx):
	if ctx.author.id not in buyers:
		...
		embed = discord.Embed(title="🚀 **CLOVNI DDOS** 🚀", color=discord.Colour.random())
		...
		embed.add_field(name="**CLOVNI-DDOS**", value="```!CLOVNI [url] [get/post]```")
		embed.set_footer(text="© Owner : CLOVNI | All Methods Command", icon_url=ctx.author.avatar)
...
async def SLOW(ctx, url, time):
	if ctx.author.id not in buyers:
		...
		embed.set_footer(text=f"© Owner : CLOVNI | Requests By {ctx.author.name}", icon_url=ctx.author.avatar)
...
async def UAM_BYPASS(ctx, url, time, req):
	if ctx.author.id not in buyers:
		embedc = discord.Embed(title="🚀 **CLOCNI DDOS** 🚀", color=0xfcb103)
		embedc.add_field(name="**Warning**",value="You Don't Have Permission To Use This Comamnd !")
		embedc.set_footer(text=f"© Owner : CLOVNI | Warning {ctx.author.name}")
		await ctx.reply(embed=embedc)
	else:
...
async def CLOVNI(ctx, url, mthd):
	if ctx.author.id not in buyers:
		...
		embed.set_thumbnail(url="https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto,q_auto,f_auto/attachments/delivery/asset/82380ffc8fe576c18d28f05250f61dc8-1603324282/Preview%20Sample/create-this-cool-neon-animation-discord-avatar.gif")
		embed.add_field(name="**Target**", value=f"`{url}`")
		embed.add_field(name="**Methods**", value="`CLOVNI-DDOS`")
		embed.add_field(name="**Duration**", value=f"`Unknowns`")
		ma1 = ["https://media4.giphy.com/media/8OTxSsEKzMs2A/giphy.gif","https://media1.giphy.com/media/3o7btQ8jDTPGDpgc6I/giphy.gif","https://media3.giphy.com/media/jOZt5tdGYxzz0H6Nfi/giphy.gif","https://media1.giphy.com/media/EKKAwvGF2sF1C7CXsy/giphy.gif"]
		rdma1 = random.choice(ma1)
		embed.set_image(url=rdma1)
		embed.set_footer(text=f"© Owner : CLOVNI | {ctx.author.name}", icon_url=ctx.author.avatar)
